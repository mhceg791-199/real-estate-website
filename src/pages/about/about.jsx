...
function About() {
  const paragraphs = [
    "Mosaic Real Estate was established in 2025 as the real estate arm of Mosaic Holding Corporation (MHC). The name “Mosaic” reflects our philosophy: distinct pieces coming together to create something stronger, richer, and more meaningful. These pieces are represented through MHC’s integrated subsidiaries, each one contributing its expertise to amplify value.",
